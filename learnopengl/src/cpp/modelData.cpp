...
unsigned int cubeVerticesSize = sizeof(cubeVertices);
float planeVertices[] = {
...
unsigned int transparentVerticesSize = sizeof(transparentVertices);
...
unsigned int skyboxVerticesSize = sizeof(skyboxVertices);